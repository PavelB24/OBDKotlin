...
internal object CommandFormatter {
    ...
    fun checkValid(
        ...
        return when(trimmedCommand.uppercase(Locale.getDefault())){
            ...
            "E1" -> {
                throw WrongInitCommandException("$trimmedCommand is not allowed" +
    ...
    fun checkPid(trimmedCommand: String): String{
        if (trimmedCommand.contains("I", true)
            ||
